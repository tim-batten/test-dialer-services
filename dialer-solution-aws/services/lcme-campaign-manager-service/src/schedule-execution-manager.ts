...
import { CampaignDefinition, CampaignPacingDefinition } from 'lcme-common/lib/models/campaign';
import {
  CampaignExecutionDefinition,
  CampaignExecutionFilterDefinition,
  CampaignExecutionSortDefinition,
} from 'lcme-common/lib/models/campaign-execution';
...
import { ScheduleDefinition, ScheduleSequenceDefinition } from 'lcme-common/lib/models/schedule';
import {
  ScheduleExecutionDefinition,
  ScheduleExecutionFilterDefinition,
  ScheduleExecutionStatus,
} from 'lcme-common/lib/models/schedule-execution';
import { RequestClient } from 'lcme-services-common/lib/requests/request-client';
import { clearStatsForCampaign } from 'lcme-services-common/lib/utils/campaign-stats-helper';
...
import { HistoricalStats } from 'lcme-common/lib/types/stats/historical-stats';
...
export class ScheduleExecutionManager {
  ...
  async sendScheduleExecutionToCrudApi(
    ...
    try {
      ...
      await this.lcmeCrudClient.post(scheduleExecutionRequest, headers, https);
    } catch (e) {
