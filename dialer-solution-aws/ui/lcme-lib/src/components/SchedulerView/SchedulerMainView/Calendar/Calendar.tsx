...
} from 'lcme-common/lib/types/schedules-api';
...
export const Calendar: React.FunctionComponent<ICalendar> = ({
  ...
  const defaultCalendarViewStr = localStorage.getItem('lcme-scheduler-view');
    ...
    <Wrapper>
      <CalendarWrapper>
        ...
        <RCalendar
          ...
          onView={(view) => {
            localStorage.setItem('lcme-scheduler-view', view);
          }}
